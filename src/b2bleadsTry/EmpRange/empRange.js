                ...
                <div className="col-12 ann-revenue-list">
                    ...
                    <div className="row">
                        ...
                        <div className="col-12" style={{ float: 'left', display: 'flex', alignItems: 'center' }}>
                            ...
                            <input type="checkbox" className="option-input checkbox" checked={this.props.totalFilters.scaleEmployeeCount.last !== 0}
                            ...
                            <div style={{ height: '100%', alignItems: 'center', marginLeft: '10px' }}>
                                <span className="annual-revenue-data-text" style={{ textAlign: 'center' }}>{this.state.recentValues[0]}  -  {this.state.recentValues.length > 1 ? this.state.recentValues[this.state.recentValues.length - 1] : null}</span>
                            </div>
                        </div>
                    </div>
                    <div className="row" hidden={this.props.totalFilters.scaleEmployeeCount.last == 0}>
                        <div className="col-12" style={{ float: 'left', display: 'flex', alignItems: 'center' }}>
                            <input type="checkbox" className="option-input checkbox" checked={this.props.totalFilters.noEmployeeCount}
                                onClick={(event) => {
                            ...
                            <div style={{ height: '100%', alignItems: 'center', marginLeft: '10px' }}>
                                <span className="annual-revenue-data-text">Include businesses with no employee count</span>
                            </div>
                        </div>
                    </div>
                    <div className="row">
                        ...
                        <div style={{ height: '100%', alignItems: 'center', marginLeft: '10px' }}>
                            <span className="annual-revenue-data-text">Employee Count Exists Or Not (Default)</span>
                        </div>
                        </div>
                    </div>
                </div>
