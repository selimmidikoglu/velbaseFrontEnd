...
class YoloTry extends Component {
    ...
    render() {
        ...
        return (
            ...
            <div className = "container custom-container" style={{pointerEvents: this.props.fetchReducer.conditionForSpinner.divPointerEvents}}>
                {this.props.fetchReducer.conditionForSpinner.runSpinner ? (<Spinner />) : null}
                <div className = "row ">
                  <div className="col-8 main-filters-container">
                      <div className="row">
                        <div className = "col-8 search-box-nav-container">
                            <div className = "col-12 search-box-container"><SearchBar/></div>
                            <div className = "row navbar1-container">
                                ...
                                onClick={() => this.props.chooseOtherSearch("category")}>
                                    <div><label className="header-categories"
                                    style={{color:this.props.chooseSearchReducer.textColorCategory}}>Categories</label></div></div>
                                ...
                                onClick={() => this.props.chooseOtherSearch("location")}>
                                    <label className="header-location"
                                     style={{color:this.props.textColorLocation}}>Locations</label></div>
                            </div>
                            
                        </div>
                        <div className = "col-4 additional-info-container">Additional Info</div>
                      </div>
                      <div className="row bottom-part">
                          <div className="col-8 categories-locations-container" style={{overflowY:this.props.chooseSearchReducer.overflowYMain}}>
