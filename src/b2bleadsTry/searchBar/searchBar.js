...
//actions
import {setSearchKeyCategories,getMatchedCategories, setSearchKeyLocations, fetchLocations,
  insertChoosenStates,getZipCodesInCities,insertChoosenCities, getCitiesInState,setSpinner, getTotalData} from '../../actions/fetchActions'
//const
        ...
        if(this.props.fetchReducer.matchedLocations.states.length > 0 || this.props.fetchReducer.matchedLocations.cities.length > 0)
          searchLocationsResults = (
              <div className = "row search-results-inner"> 
                ...
                style={{color:this.props.fetchReducer.totalFilters.cities[data.city]&&this.props.fetchReducer.totalFilters.cities[data.city].state === data.state?'rgb(62, 126, 179)':'#808080',
      ...
      console.log(this.props)
        ...
        let locations_search = (
          <div className= "row " ref="search">
              <div className= "col-12 search-bar"><input type="text" className = "search-text" placeholder="Searh Locations..exp: Alabama, Washington, DC"
